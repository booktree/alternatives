...
| Technology stack (13)          | Git, Rails, Redcarpet, Gollum | Git, Rails, Redcarpet, Gollum | [GitLab](https://twitter.com/madebyloren/status/468917323588698112), Prose | GitLab, [HTMLBook](https://github.com/oreillymedia/HTMLBook), [CKEditor](https://github.com/ckeditor/ckeditor-dev), [Docker](https://github.com/odewahn/docker-at-oreilly) | Node.js, Marked fork, Calibre | Node.js, Ace          | CodeMirror | [Git](https://www.authorea.com/aboutus), Rails       | NodeGit, Express, (15)                             | ?     | ?                                                                           | ?       | Python     | PHP        | ?                               | ?                        |
...
| **Meta**                       |                               |                               |                                                                            |                                                                                                                                                                            |                               |                       |            |                                                      |                                                    |       |                                                                             |         |            |            |                                 | ?                        |
| Developers                     | 230 employees                 | 5                             | 1                                                                          | >= 3 (27)                                                                                                                                                                  | ?                             | 2                     | ?          | [3](https://www.authorea.com/contact)                | [2](http://www.crunchbase.com/organization/beegit) | 1     | [9](http://www.crunchbase.com/organization/inkling-inc) (multiple projects) | ?       | ?          | ?          | ?                               | 3                        |
...
-   (27) Hard to estimate since they are a big organization with multiple projects.
    ...
    - Andrew Odewahn: <http://forum.atlas.oreilly.com/users/odewahn/activity>
    - Adam Zaremba: <http://forum.atlas.oreilly.com/users/zaremba/activity>
    - Sarah: <http://forum.atlas.oreilly.com/users/sarahs/activity>
...
Limited merge request functionality through editing:
you make suggestions and they appear rendered with a comment.
Once accepted or decline, the comment is gone.
...
Each user works on a single branch at a time:
<http://forum.atlas.oreilly.com/t/have-multiple-branches-per-user-before-submitting-pull-request/75>
...
Pull request revision is hardcore: you can accept each of the diff hunks individually,
edit the entire file on a single UI, and jump to the next hunk with a button.
...
So all users use branches in the same repository.
This means that any user with write access can overwrite the branches of other users if he wants.
